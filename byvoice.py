...
with speech_recognition.Microphone() as src:
    ...
    while True:
        ...
        #---------------------------------------------------------------------
        if (speech_to_txt == "quit program") or (speech_to_txt == "out"):
            break
        ...
        elif speech_to_txt == "mouse lift" or speech_to_txt == "move lift":
            ...
            gui.mute_unmute()
        elif speech_to_txt == "play" or speech_to_txt=="stop":
            gui.play_pause()