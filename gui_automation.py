...
class gui_control:
    ...
    def mouse_down(self,recognizer, src):
        while True:
            speech_to_txt = ""
            pyautogui.moveRel(0, 1*SLOWER, duration=0.15)
            try:
                audio = recognizer.listen(src)
                speech_to_txt = recognizer.recognize_google(audio).lower()
            except:
            ...
            if speech_to_txt == "stop":
                ...
                pyautogui.moveRel(0, 1*FASTER, duration=0.15)
            elif speech_to_txt == "slower":
                pyautogui.moveRel(0, 1*SLOWER, duration=0.15)
    ...
    def mouse_right(self,recognizer, src):
        ...
        while True:
            speech_to_txt = ""
            pyautogui.moveRel(1*SLOWER, 0, duration=0.15)
            try:
                audio = recognizer.listen(src)
                speech_to_txt = recognizer.recognize_google(audio).lower()
            except:
            ...
            if speech_to_txt == "stop":
                ...
                pyautogui.moveRel(1*FASTER, 0, duration=0.15)
            elif speech_to_txt == "slower":
                pyautogui.moveRel(1*SLOWER, 0, duration=0.15)
